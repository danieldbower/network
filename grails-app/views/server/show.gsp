...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="create" controller="connection" action="create"  params="['server.id':serverInstance.id]"><g:message code="connection.new.label" default="New Connection" /></g:link></span>
            <span class="menuButton"><g:link class="create" controller="buildScript" action="create"  params="['server.id':serverInstance.id]"><g:message code="buildScript.new.label" default="New Build Script" /></g:link></span>
        </div>
        <div class="body">
