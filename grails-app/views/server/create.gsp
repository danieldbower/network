                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: serverInstance, field: 'connections.address', 'errors')}">
                                    <g:textField name="connections[0].address" size="40" value="${serverInstance?.connections?.toList()?.getAt(0)?.address}" />
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: serverInstance, field: 'buildScripts.text', 'errors')}">
                                    <g:textArea name="buildScripts[0].text" cols="80" rows="5" value="${serverInstance?.buildScripts?.toList()?.getAt(0)?.text}" />
                                </td>
                            </tr>
